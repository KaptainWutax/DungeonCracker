...
public class Floor {
	...
	static {
		try {
			UNKNOWN = new Image(Floor.class.getClassLoader().getResourceAsStream("unknown.png"));
			MOSSY = new Image(Floor.class.getClassLoader().getResourceAsStream("mossy.png"));
			COBBLE = new Image(Floor.class.getClassLoader().getResourceAsStream("cobble.png"));
